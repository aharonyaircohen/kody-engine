 ...
 *
 * Typical placement: right before commitAndPush in any agentAction that commits
 * the agent's edits. AgentActions that intentionally leave MERGE_HEAD in place

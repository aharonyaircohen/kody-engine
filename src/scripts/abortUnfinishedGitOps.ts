 ...
 *
 * Typical placement: right before commitAndPush in any implementation that commits
 * the agent's edits. Implementations that intentionally leave MERGE_HEAD in place

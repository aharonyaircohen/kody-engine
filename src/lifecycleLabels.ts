/**
 * Kody labels — mechanism-only helper. No agentAction, phase, or group
...
import type { ScriptEntry } from "./agent-actions/types.js"
...
/**
 * Walk every agentAction profile and harvest label specs declared on

...
export const CHAT_SYSTEM_PROMPT = [
  ...
  "plausible ways, or you'd have to guess what they actually want — ask ONE",
  "concise clarifying question and stop. Do NOT pick an interpretation and run",
  "with it. This check comes first: confirm intent before you start",
  "investigating or making changes.",
  "",

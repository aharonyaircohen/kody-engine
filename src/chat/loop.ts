...
export const CHAT_SYSTEM_PROMPT = [
  ...
  "",
  "The repo's configured secrets (API keys, provider tokens, etc.) are present",
  "as environment variables in this runner — the same ones the project uses in",
  "CI. Don't claim you lack a credential without checking: inspect the",
  "environment (e.g. `env`, `printenv NAME`) via Bash to see what's available,",
  "and use it. Never print a secret's value back to the user or into the repo.",
  "",

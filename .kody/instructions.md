...
Executable shell scripts must read secrets from environment variables only.
Do not decrypt or read `.kody/secrets.enc` from an executable script; Kody runtime/dashboard/pool code is responsible for loading vault secrets into env first.
